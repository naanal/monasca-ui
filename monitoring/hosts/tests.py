...
from monitoring.hosts import views
...
class HostsTest(helpers.TestCase):
    def test_index_get(self):
        res = self.client.get(INDEX_URL)
        self.assertTemplateUsed(
            res, 'monitoring/hosts/index.html')
        self.assertTemplateUsed(res, 'monitoring/hosts/monitor.html')
